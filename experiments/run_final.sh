...
MASTER_LOG="${LOG_DIR}/master_final.log"
...
for SEED in "${EXTRA_SEEDS[@]}"; do
    ...
    CMD=("$PYTHON" experiments/run_improved.py "${BASE_FLAGS[@]}" --seed "$SEED")
